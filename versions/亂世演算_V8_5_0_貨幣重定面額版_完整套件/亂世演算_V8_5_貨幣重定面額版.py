...
ENGINE_VERSION = "亂世演算V8_5_貨幣重定面額版"
SEASON_SECONDS = 1000
SEASON_YEAR = 2 # 幾秒/年 
SEASON_RATIO = 1 # 加速幾倍
...
WORLD_CURRENCY_NAME_OPTIONS = (
    ...
    "金元", "金幣", "金盾", "金冠", "金銖", "金票", "金圓", "金龍", "金鷹", "金葉",
    "銅元", "銅幣", "銅盾", "銅銖", "銅圓", "銅票", "銅冠", "銅錢", "赤銅", "青銅",
    "帝國幣", "王國幣", "共和幣", "同盟幣", "公國幣", "自治幣", "自由幣", "統一幣", "中央幣", "國民幣",
    "天元", "地元", "玄元", "乾元", "坤元", "洪元", "蒼元", "聖元", "皇元", "龍元",
    "太陽幣", "月亮幣", "星辰幣", "銀河幣", "宇宙幣", "曙光幣", "永恆幣", "黎明幣", "輝煌幣", "光輝幣",
    "海洋幣", "大陸幣", "群島幣", "港灣幣", "遠洋幣", "航海幣", "商港幣", "貿易幣", "通商幣", "航運幣",
    "龍幣", "鳳幣", "獅幣", "鷹幣", "虎幣", "狼幣", "鹿幣", "鯨幣", "鶴幣", "麒麟幣",
    "寶元", "寶幣", "寶銖", "寶盾", "寶冠", "寶票", "寶圓", "寶銀", "寶金", "寶鈔",
)
