...
# 3. 人口不再每輪暴增 15~25，而改成約 0.5~1.2% 且單輪最多 5 人。
...
BALANCE = {
    # 人口與住房
    "HOUSE_WOOD_COST": 100,
    "HOUSE_BUILD_THRESHOLD": 0.88,
    "FOOD_COST_PER_BIRTH": 8,
    "BIRTH_MIN_RESERVE_TURNS": 6.0,
    "BIRTH_RATE_MIN": 0.005,
    "BIRTH_RATE_MAX": 0.012,
    "BIRTH_MAX_PER_TURN": 5,

    # 農民基礎產能（每名被分派到該工作的農民／每輪）
    "FOOD_PER_WORKER": 4.0,
    "WOOD_PER_WORKER": 1.8,
    "METAL_PER_WORKER": 1.5,
    ...
    # 庫存過高時，採集效率下降（不是硬砍庫存）
    "SURPLUS_PRODUCTION_FACTOR": 0.15,
    "SURPLUS_FOOD_PRODUCTION_FACTOR": 0.30,
