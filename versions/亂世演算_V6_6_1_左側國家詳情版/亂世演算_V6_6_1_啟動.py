...
from 亂世演算_V6_6_1_左側國家詳情版 import thread_stat_monitor
...
class GameInterfaceUI:
    def __init__(self, root):
        ...
        self.left_notebook.add(self.tab_ally_detail, text=" 🛡️聯盟詳細查詢 ")
