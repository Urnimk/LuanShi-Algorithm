...
ENGINE_VERSION = "亂世演算V8_5_12_時間與重建保護修正版"
...
REBUILD_PROTECTION_YEARS = 500
REBUILD_PROTECTION_BLOCK_ATTACK = True
REBUILD_PROTECTION_BLOCK_ALLIANCE = True
...
# 國際忌憚值機制
INTERNATIONAL_DREAD_CANDIDATE_THRESHOLD = 100000
