...
from 亂世演算_V6_5_1_國家編年史快捷鍵版 import thread_stat_monitor
...
# ------------------------------------------------------------------------------
# 主視窗頂部標題列所顯示的文字名稱
WINDOW_TITLE = "亂世演算 V6.5.1｜國家編年史快捷鍵・戰力權重投票・世代分流"
...
class GameInterfaceUI:
    def __init__(self, root):
        ...
        # Tab 1：維持原本「世界排名 + 即時 LOG」畫面。
        self.tab_live_world = ttk.Frame(self.right_notebook)
        ...
        # Tab 2：國家編年史
        # ----------------------------------------------------
        self.tab_chronicle = ttk.Frame(self.right_notebook)
        self.right_notebook.add(
            self.tab_chronicle,
            text=" 📜 國家編年史 ",
        )
        ...
        for col, title, width, anchor in chronicle_specs:
            self.chronicle_tree.heading(col, text=title)
    ...
    def open_selected_country_chronicle(self):
        ...
        # 切換右側 Notebook，而不是改動左側目前的國家詳細查詢。
        self.right_notebook.select(self.tab_chronicle)
