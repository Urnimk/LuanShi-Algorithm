...
try:
    from 亂世演算_V8_5_1_國家經驗查詢版 import (
        thread_stat_monitor,
...
# ------------------------------------------------------------------------------
# 主視窗頂部標題列所顯示的文字名稱
WINDOW_TITLE = "亂世演算 V8_5_1｜國家經驗查詢版"
...
class GameInterfaceUI:
    ...
    def refresh_country_experience(self):
        ...
        q_path = save_path("rl_strategic_q_readable.txt")
        try:
            ...
            content = extract_country_experience(report, (country_key, display_name))
            if content is None:
                content = f"{display_name} 目前沒有已存檔的戰略 Q 值。\n報表更新後，可按右上角「更新」。"
